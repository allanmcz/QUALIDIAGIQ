...
Após alterar routers ou schemas Pydantic expostos na API, regenere e inclua o diff no PR. O **CI** (`backend` job) falha se o ficheiro commitado divergir da exportação actual (`git diff`).
