<p align="center">
  <img src="../frontend/public/brand/QDI-NB1-logo-completo.jpg" alt="QualiDiagIQ" width="280" />
</p>

# Documentação do Sandbox `018-QUALIDIAGIQ`

## Índice

| # | Documento | Conteúdo |
|---|-----------|----------|
| 01 | [Arquitetura](01_arquitetura.md) | Clean Architecture, decisões de stack, diagramas |
...
- **PRD-base:** `../../../03_GAP_ANALYSIS_QDI/recomendacoes_prd_qdi.md`
- **Gap Analysis:** `../../../03_GAP_ANALYSIS_QDI/gap_analysis_oportunidades.md`
- **MoSCoW:** `../../../03_GAP_ANALYSIS_QDI/matriz_decisao_features_qdi.md`
- **Matriz Competitiva:** `../../../02_BENCHMARK_CONCORRENTES/00_MATRIZ_COMPARATIVA.md`
