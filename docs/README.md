...
| **`docs/api/openapi.generated.json`** | OpenAPI 3 gerado pela app FastAPI (`make openapi-export`) — diff em PR; regressão de paths em `tests/unit/presentation/test_openapi_generated_contract.py`. |
