...
- **Contrato OpenAPI (2026-05-10):** `docs/api/openapi.generated.json` passa a ser **versionado** (`make openapi-export`); teste de integração ASGI para GET export `formato=pacote_pdf`.
