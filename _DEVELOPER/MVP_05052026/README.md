...
> **Plano HANDOFF de execução (este corte):** **[`HANDOFF_PLANO_EXECUCAO_MVP_05052026.md`](./HANDOFF_PLANO_EXECUCAO_MVP_05052026.md)** — fases F0–F4, IDs Z1–Z11, registo §7.  
...
| # | Ficheiro | Conteúdo |
|---|----------|----------|
| **H** | [`HANDOFF_PLANO_EXECUCAO_MVP_05052026.md`](./HANDOFF_PLANO_EXECUCAO_MVP_05052026.md) | **Plano HANDOFF** — fases F0–F4, checklist Z, registo execução §7 |
...
0. **`HANDOFF_PLANO_EXECUCAO_MVP_05052026.md`** — ordem de execução e IDs **Z**.  
1. `docs/operacao/CHECKLIST_CONFIRMACAO_ALLAN_MVP.md` — **só para go-live público** (sec. 1–3); em **D**, usar sobretudo critérios **§2** de `02_CRITERIOS_ACEITE_EVIDENCIAS.md`.  
2. `_DEVELOPER/HANDOFF_PROXIMA_SESSAO_QDI.md` — **§12.3** (P5, P6) para sincronizar estado após o corte.  
3. `docs/operacao/SMOKE_MVP_FECHADO.md` + `make mvp-gate`.

---

*Criado para alinhamento explícito ao calendário **2026-05-05**.*
