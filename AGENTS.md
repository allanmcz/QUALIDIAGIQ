# AGENTS.md — Contexto Persistente para Codex

> Carregado automaticamente pelo Codex ao abrir esta pasta.
...
**Mantido por:** Allan + Codex (Anthropic)
